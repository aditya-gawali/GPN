                                    ...
                                    <div class="container" data-aos="fade-up">
                                        ...
                                        <div class="row g-5">
                                            ...
                                            ?>
                                                ...
                                                <div class="me-service col-md-6 col-lg-4" data-aos="zoom-in" >
                        ...
                        <section id="application" class="application">
                            <div class="container" data-aos="fade-up">
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="me-service col-md-6 col-lg-6" data-aos="zoom-in" >
                                        <a href="<?php echo $row->link; ?>" target="blank">
                                            <div class="box shadow">
                        ...
                        <div class="row portfolio-container" data-aos="fade-up" >
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    <img src="navbar-assets/img/student_corner/alu1.jpg" class="img-fluid" alt="">

                                    <div class="portfolio-links">
                                        <a href="navbar-assets/img/student_corner/alu1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bi bi-arrows-fullscreen px-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    <img src="navbar-assets/img/student_corner/alu2.jpg" class="img-fluid" alt="">
                                    <div class="portfolio-info">
                                        <!-- <h4>about</h4> -->
                                        <!-- <p>App</p> -->
                                    </div>
                                    <div class="portfolio-links">
                                        <a href="navbar-assets/img/student_corner/alu2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bi bi-arrows-fullscreen px-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    <img src="navbar-assets/img/student_corner/alu3.jpg" class="img-fluid" alt="">
                                    <div class="portfolio-info">
                                        <!-- <h4>about</h4> -->
                                        <!-- <p>App</p> -->
                                    </div>
                                    <div class="portfolio-links">
                                        <a href="navbar-assets/img/student_corner/alu3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bi bi-arrows-fullscreen px-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    <img src="navbar-assets/img/student_corner/alu4.jpg" class="img-fluid" alt="">
                                    <div class="portfolio-info">
                                        <!-- <h4>about</h4> -->
                                        <!-- <p>App</p> -->
                                    </div>
                                    <div class="portfolio-links">
                                        <a href="navbar-assets/img/student_corner/alu4.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bi bi-arrows-fullscreen px-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    <img src="navbar-assets/img/student_corner/alu5.jpg" class="img-fluid" alt="">
                                    <div class="portfolio-info">
                                        <!-- <h4>about</h4> -->
                                        <!-- <p>App</p> -->
                                    </div>
                                    <div class="portfolio-links">
                                        <a href="navbar-assets/img/student_corner/alu5.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bi bi-arrows-fullscreen px-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                                <div class="portfolio-wrap">
                                    <img src="navbar-assets/img/student_corner/alu6.jpg" class="img-fluid" alt="">
                                    <div class="portfolio-info">
                                        <!-- <h4>about</h4> -->
                                        <!-- <p>App</p> -->
                                    </div>
                                    <div class="portfolio-links">
                                        <a href="navbar-assets/img/student_corner/alu6.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title=""><i class="bi bi-arrows-fullscreen px-2"></i></a>
                                    </div>
                                </div>
                            </div>
